...
Usage:
$python BaseCalibration.py --Read1 AccRep1_deconvoluted_R1.compareBase.txt --Read2 AccRep1_R2.compareBase.txt --name AccRep1
...
(3) tempory dir is named based on time, could be called by different runs.
'''
...
def main(Read1, Read2, name):
    ...
    pool = ProcessPool(nodes=8) # smp=8
